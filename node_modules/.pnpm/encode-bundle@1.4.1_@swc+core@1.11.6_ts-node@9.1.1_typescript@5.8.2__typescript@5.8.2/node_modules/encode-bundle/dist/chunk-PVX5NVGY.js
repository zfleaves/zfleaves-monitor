...
var init_sourcemap_codec_es = _chunkALEPYAF2js.__esm.call(void 0, {
  "node_modules/.pnpm/sourcemap-codec@1.4.8/node_modules/sourcemap-codec/dist/sourcemap-codec.es.js"() {
    "use strict";
    charToInteger = {};
...
_chunkALEPYAF2js.__export.call(void 0, magic_string_es_exports, {
  Bundle: () => Bundle,
  SourceMap: () => SourceMap,
  default: () => MagicString
});
...
var init_magic_string_es = _chunkALEPYAF2js.__esm.call(void 0, {
  "node_modules/.pnpm/magic-string@0.25.9/node_modules/magic-string/dist/magic-string.es.js"() {
    "use strict";
...
// node_modules/.pnpm/rollup-plugin-hashbang@3.0.0_rollup@3.28.1/node_modules/rollup-plugin-hashbang/dist/index.js
var require_dist = _chunkALEPYAF2js.__commonJS.call(void 0, {
  "node_modules/.pnpm/rollup-plugin-hashbang@3.0.0_rollup@3.28.1/node_modules/rollup-plugin-hashbang/dist/index.js"(exports, module) {
    "use strict";
    ...
    var import_fs2 = __toESM(_chunkALEPYAF2js.__require.call(void 0, "fs"));
    var import_path2 = __toESM(_chunkALEPYAF2js.__require.call(void 0, "path"));
    var import_magic_string = __toESM((init_magic_string_es(), _chunkALEPYAF2js.__toCommonJS.call(void 0, magic_string_es_exports)));
    var src_default = () => {
...
var loadJson = async (filepath) => {
  try {
    return _chunkALEPYAF2js.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
async function loadEncodeBundleConfig(cwd, configFile) {
...
async function getProductionDeps(cwd, clearCache = false) {
  ...
  const deps = Array.from(
    /* @__PURE__ */ new Set([...Object.keys(data.dependencies || {}), ...Object.keys(data.peerDependencies || {})])
  );
  return deps;
}
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkNOCM5USSjs.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkNOCM5USSjs.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkNOCM5USSjs.dim.call(void 0, "]")}`,
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkNOCM5USSjs.bold.call(void 0, padRight(name, maxLength))}${_chunkNOCM5USSjs.green.call(void 0, 
...
exports.loadEncodeBundleConfig = loadEncodeBundleConfig; exports.loadPkg = loadPkg; exports.getProductionDeps = getProductionDeps; exports.getAllDepsHash = getAllDepsHash; exports.setSilent = setSilent; exports.getSilent = getSilent; exports.createLogger = createLogger; exports.reportSize = reportSize; exports.require_dist = require_dist;
