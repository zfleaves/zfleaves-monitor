...
var require_flat = _chunkALEPYAF2js.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkALEPYAF2js.__toESM.call(void 0, require_flat());
var _cac = require('cac');
function ensureArray(input) {
  return Array.isArray(input) ? input : input.split(",");
}
async function main(options = {}) {
  const cli = _cac.cac.call(void 0, "encode-bundle");
  cli.command("[...files]", "Bundle files", {
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkALEPYAF2js.slash);
    }
    if (flags.format) {
  ...
  cli.help();
  cli.version(_chunkB4TZP5XLjs.version);
