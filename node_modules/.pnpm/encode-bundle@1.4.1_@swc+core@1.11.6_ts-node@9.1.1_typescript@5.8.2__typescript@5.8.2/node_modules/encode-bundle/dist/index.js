...
var _chunkB4TZP5XLjs = require('./chunk-B4TZP5XL.js');
...
var require_consola = _chunkALEPYAF2js.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkALEPYAF2js.__require.call(void 0, "util"));
    var e = _chunkALEPYAF2js.__require.call(void 0, "path");
    var t = _chunkALEPYAF2js.__require.call(void 0, "fs");
    var r = u(_chunkALEPYAF2js.__require.call(void 0, "os"));
    var n = u(_chunkALEPYAF2js.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var _ = class __ {
      ...
      create(u2) {
        return new __(Object.assign({ reporters: this._reporters, level: this.level, types: this._types, defaults: this._defaults, stdout: this._stdout, stderr: this._stderr, mockFn: this._mockFn }, u2));
      }
      withDefaults(u2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkALEPYAF2js.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkALEPYAF2js.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkALEPYAF2js.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkALEPYAF2js.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunkALEPYAF2js.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkALEPYAF2js.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkALEPYAF2js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkALEPYAF2js.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunkALEPYAF2js.defaultOutExtension;
  const defaultExtension = _chunkALEPYAF2js.defaultOutExtension.call(void 0, { format, pkgType });
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkPVX5NVGYjs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkALEPYAF2js.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkPVX5NVGYjs.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkALEPYAF2js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkNOCM5USSjs.PrettyError)(
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkALEPYAF2js.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkALEPYAF2js.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkALEPYAF2js.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkNOCM5USSjs.PrettyError)(
...
var cjsInterop = () => {
  return {
    name: "cjs-interop",
    async renderChunk(code, info) {
      if (!this.options.cjsInterop || this.format !== "cjs" || info.type !== "chunk" || !/\.(js|cjs)$/.test(info.path) || !info.entryPoint || _optionalChain([info, 'access', _14 => _14.exports, 'optionalAccess', _15 => _15.length]) !== 1 || info.exports[0] !== "default") {
        return;
      }
      return {
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkNOCM5USSjs.PrettyError)(`No input files, try "encode-bundle <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkNOCM5USSjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkNOCM5USSjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    options.tsconfigResolvePaths = _optionalChain([tsconfig, 'access', _16 => _16.data, 'optionalAccess', _17 => _17.compilerOptions, 'optionalAccess', _18 => _18.paths]) || {};
    options.tsconfigDecoratorMetadata = _optionalChain([tsconfig, 'access', _19 => _19.data, 'optionalAccess', _20 => _20.compilerOptions, 'optionalAccess', _21 => _21.emitDecoratorMetadata]);
    if (options.dts) {
    ...
    if (!options.target) {
      options.target = _optionalChain([tsconfig, 'access', _22 => _22.data, 'optionalAccess', _23 => _23.compilerOptions, 'optionalAccess', _24 => _24.target, 'optionalAccess', _25 => _25.toLowerCase, 'call', _26 => _26()]);
    }
  } else if (options.tsconfig) {
    throw new (0, _chunkNOCM5USSjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkPVX5NVGYjs.loadEncodeBundleConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(async (item) => {
      const logger = _chunkPVX5NVGYjs.createLogger.call(void 0, _optionalChain([item, 'optionalAccess', _27 => _27.name]));
      const options = await normalizeOptions(logger, item, _options);
      logger.info("CLI", `encode-bundle v${_chunkB4TZP5XLjs.version}`);
      if (config.path) {
      ...
      const dtsTask = async () => {
        if (options.dts) {
          await new Promise((resolve, reject) => {
            ...
            worker.postMessage({
              configName: _optionalChain([item, 'optionalAccess', _28 => _28.name]),
              options: {
                ...options,
      ...
      const mainTasks = async () => {
        if (!_optionalChain([options, 'access', _29 => _29.dts, 'optionalAccess', _30 => _30.only])) {
          let onSuccessProcess;
          let onSuccessCleanup;
          const buildDependencies = /* @__PURE__ */ new Set();
          let depsHash = await _chunkPVX5NVGYjs.getAllDepsHash.call(void 0, process.cwd());
          ...
          const debouncedBuildAll = _chunkALEPYAF2js.debouncePromise.call(void 0, 
            () => {
              return buildAll();
            },
            100,
            _chunkNOCM5USSjs.handleError
          );
          const buildAll = async () => {
            ...
            if (options.clean) {
              ...
              await _chunkALEPYAF2js.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
          ...
          const startWatcher = async () => {
            ...
            watcher.on("all", async (type, file) => {
              file = _chunkALEPYAF2js.slash.call(void 0, file);
              ...
              if (options.watch === true) {
                if (file === "package.json" && !buildDependencies.has(file)) {
                  const currentHash = await _chunkPVX5NVGYjs.getAllDepsHash.call(void 0, process.cwd());
