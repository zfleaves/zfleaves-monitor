import { getAppId, isWxMiniEnv, variableTypeDetection } from "zfleaves-monitor-utils";
import { ErrorTypes, EventTypes } from "zfleaves-monitor-shared";
...
export function generatePromiseErrorId(data: ReportDataType, apikey: string): string {
