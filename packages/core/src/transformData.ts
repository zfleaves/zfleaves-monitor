import { BreadCrumbTypes, ErrorTypes, globalVar } from 'zfleaves-monitor-shared';
import {
    getLocationHref,
    getTimestamp,
    Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'zfleaves-monitor-type';
